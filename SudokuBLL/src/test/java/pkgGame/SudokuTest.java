...
/*	private void PrintStars() {
	...
	@Test
	public void Sudoku_Sudoku_1() throws Exception {
		Sudoku s1 = new Sudoku(eGameDifficulty.EASY,9);
	}
	@Test
	public void Sudoku_test() throws Exception {
		Sudoku s1 = new Sudoku(eGameDifficulty.EASY,9);
		s1.IsDifficultyMet_1(101);
		s1.IsDifficultyMet_1(599);
		s1.SetRemainingCells_test();
	}
}
